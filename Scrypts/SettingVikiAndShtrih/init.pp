...
)
{
	...
	file { "frShtrih.ini" :
    		name   => "/opt/FirstHelpAndScan/frShtrih.ini",
    		source => "puppet:///modules/stels_help/frShtrih.ini",
			require     => [ Exec[ 'InstallPythonScan' ], File[ '/opt/FirstHelpAndScan/' ], File[ '/opt/FirstHelpAndScan/driverssource/' ] ],
			mode   => "0777",
    }
	file { "frViki.ini" :
    		name   => "/opt/FirstHelpAndScan/frViki.ini",
    		source => "puppet:///modules/stels_help/frViki.ini",
			require     => [ Exec[ 'InstallPythonScan' ], File[ '/opt/FirstHelpAndScan/' ], File[ '/opt/FirstHelpAndScan/driverssource/' ] ],
			mode   => "0777",
    }
