...
echo "Выгрузка лога МРЦ"
	sshpass -pPk#St1vg scp -o StrictHostKeyChecking=no $LOGFILEPATH artix@10.9.0.1:/opt/utm_log/
...
echo "Выгрузка лога УТМ"
sshpass -pPk#St1vg scp -o StrictHostKeyChecking=no $LOGFILEPAT artix@10.9.0.1:/opt/utm_log/
